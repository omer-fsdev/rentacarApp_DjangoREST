...
class Reservation(models.Model):
    ...
    car = models.ForeignKey(Car, on_delete=models.CASCADE, related_name='reservation')
    start_date = models.DateField()
    end_date = models.DateField()
    
    def __str__(self):
        return f'Customer {self.customer} booked {self.car} from {self.start_date} to {self.end_date}.'
